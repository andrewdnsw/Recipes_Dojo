        ...
        function showAlbumContent($this, albimID, description){
            ...
            if (Cache.__overview){
                $album.append($("<div/>")
                    ...
                    .append($("<div/>")
					.html('<img class="descript_img" src="http://vt.obninsk.ru/common/picasa_holder_blue.gif" alt="" title="Вернуться к списку альбомов" style="border:2px solid silver;box-shadow:4px 5px 2px grey;border-radius:8px;padding:6px;padding-bottom:2px;bottom:6px;">')
				...
				if (description){
					...
					.css({'color':'navy', 'height':'102px', 'display':'table-cell', 'vertical-align':'middle'})
